...
import { ChartTypes, DataItem, GaugeTypes, PrimitiveArray } from "./types";
...
export interface AreaLinearGradientOptions {
   ...
   */
  stops?: Array<
    [number, string | null | ((this: Chart, id: string) => string), number]
  >;
}
...
export interface TooltipOptions {
  ...
  order?:
    | string
    | any[]
    | ((this: Chart, data1: any, data2: any) => number)
    | null;
